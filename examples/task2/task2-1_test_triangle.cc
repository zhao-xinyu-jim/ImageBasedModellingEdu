...
int main(int argc, char* argv[])
{
     ...
     */
    {
        math::Vec4d a1 = P1.row(2) * p1[0] - P1.row(0);
        math::Vec4d a2 = P1.row(2) * p1[1] - P1.row(1);
        math::Vec4d a3 = P2.row(2) * p2[0] - P2.row(0);
        math::Vec4d a4 = P2.row(2) * p2[1] - P2.row(1);
        std::copy(a1.begin(), a1.end(), A.begin());
        std::copy(a2.begin(), a2.end(), A.begin() + 4);
        std::copy(a3.begin(), a3.end(), A.begin() + 8);
        std::copy(a4.begin(), a4.end(), A.begin() + 12);
    }
